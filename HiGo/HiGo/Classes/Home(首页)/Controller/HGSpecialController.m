...
-(void)sendRequest
{
    [HGHttpTool getWirhUrl:HGURL parms:nil success:^(id json) {
        ...
        [arrays addObjectsFromArray:self.specialArray];
        
        self.specialArray=arrays;
...
-(void)loadMoreData
{
    [HGHttpTool getWirhUrl:HGURL parms:nil success:^(id json) {
        ...
        [self.specialArray addObjectsFromArray:arrays];
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HGSpecialModel *specialModel=self.specialArray[indexPath.item];
